...
const QUEUE_LOCK_NAME = "brs_http_queue_lock";

let activeConfig = { url: "" };
...
async function popFromQueue(limit) {
  return navigator.locks.request(QUEUE_LOCK_NAME, async () => {
...
chrome.alarms.onAlarm.addListener((alarm) => {
  if (alarm.name === ALARM_NAME && activeConfig.url) {
    flushFailedQueue(activeConfig.url); 
  }
});
